...
public interface OrderRepo extends JpaRepository<OrderEntity, Integer> {
       ...
       @Query("SELECT o FROM OrderEntity o " +
                     ...
                     "AND (:month IS NULL OR MONTH(o.date) = :month) " +
                     "AND (:day IS NULL OR DAY(o.date) = :day) " +
                     "AND o.status = 'Đã giao'") // Thêm điều kiện trạng thái
       ...
       @Query("SELECT o FROM OrderEntity o " +
                     ...
                     "AND o.status = 'Đã giao'") // Thêm điều kiện trạng thái
       List<OrderEntity> getOrdersByMonth(@Param("year") int year,
       ...
       @Query("SELECT o FROM OrderEntity o " +
                     ...
                     "AND DAY(o.date) = :day " +
                     "AND o.status = 'Đã giao'") // Thêm điều kiện trạng thái
       List<OrderEntity> getOrdersByDay(@Param("year") int year,
                     @Param("month") int month,
                     @Param("day") int day);
}
